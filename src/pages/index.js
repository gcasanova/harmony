...
const IndexPage = () => (
  <div className={'text-center'}>
    ...
    <p>Síguenos en Facebook e Instagram y entérate de todas nuestras novedades y promociones.</p>
    <p>Pide tu cita a través de Whatsapp, por teléfono o por email.</p>
    <p>¡Te esperamos!</p>
  </div>
)
